...
class PaperFillCalibrator:
    ...
    def _calibrate_slippage(self, observations: list[FillObservation]):
        ...
        included_obs = [
            o for o in observations if o.included and o.realized_slippage_bps is not None
        ]
        if len(included_obs) < 10:
            return

        # Calculate adverse slippage (realized - quoted)
        adverse_slippages = [o.realized_slippage_bps - o.quoted_slippage_bps for o in included_obs]
        ...
        mev_candidates = [
            a - self.slippage_model.base_bps
            for a in adverse_slippages
            if a > self.slippage_model.base_bps + 20
        ]
        ...
        obs_with_liquidity = [
            (o.liquidity_usd, o.realized_slippage_bps - o.quoted_slippage_bps)
            for o in included_obs
            if o.liquidity_usd and o.liquidity_usd > 0
        ]
