...
class CounterfactualData:
    ...
    price_at_skip: float
    price_1h_later: float | None = None
    price_24h_later: float | None = None
    max_price_24h: float | None = None
    min_price_24h: float | None = None

    @property
    def return_1h(self) -> float | None:
    ...
    @property
    def return_24h(self) -> float | None:
    ...
    @property
    def max_return_24h(self) -> float | None:
    ...
    @property
    def was_profitable(self) -> bool | None:
...
class ScanOutcome:
    ...
    counterfactual: CounterfactualData | None = None
...
class OutcomeTracker:
    ...
    async def cleanup_old_pending(self, max_age_hours: int | None = None):
    ...
    async def get_statistics(self) -> dict[str, Any]:
        ...
        counterfactual_outcomes = [
            ...
            and o.get("was_profitable_counterfactual") is not None
        ]
        counterfactual_wins = sum(
            1 for o in counterfactual_outcomes if o.get("was_profitable_counterfactual")
        )
        cf_count = len(counterfactual_outcomes)
        ...
        return {
            ...
            "counterfactual_win_rate": counterfactual_wins / cf_count if cf_count else 0,
