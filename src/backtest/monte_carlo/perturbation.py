...
class Perturbator:
    ...
    def perturb_trade(
        ...
        result.mev_impact_bps = abs(entry_after_mev - entry_after_slippage) / entry_after_slippage * 10000
        ...
        original_pnl_pct = (exit_price - entry_price) / entry_price * 100
        adjusted_pnl_pct = (
            result.adjusted_exit_price - result.adjusted_entry_price
        ) / result.adjusted_entry_price * 100
