...
class FlashCrashScenario(ScenarioInjector):
    ...
    def __init__(
        ...
        self._crash_events: Dict[str, Tuple[int, float]] = {}  # mint -> (crash_time, pre_crash_price)
...
class ScenarioEngine:
    ...
    def remove_scenario(self, scenario_type: ScenarioType) -> None:
        ...
        self.scenarios = [
            (inj, cfg) for inj, cfg in self.scenarios
            if inj.scenario_type != scenario_type
        ]
    ...
    def get_stats(self) -> Dict[str, ScenarioStats]:
        ...
        return {
            injector.scenario_type.value: injector.stats
            for injector, _ in self.scenarios
        }
